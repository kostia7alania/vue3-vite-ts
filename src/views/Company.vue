    ...
    <section class="px-16px-48px-80px py-80px-120px-120px">
      <div class="max-layout-width">
        <div class="topic-title tw-flex tw-justify-center">
          ...
          >{{ $t('We combine traditional consulting model') }}</div>
        </div>
        ...
        <div :class="{
          ...
          >
            ...
            <div class="tw-basis-2/3 tw-grow-0 tw-shrink-1">
              ...
              <div
                class="tw-font-semibold tw-text-xl tw-mt-6"
              >{{ $t('Our main tenets for success') }}:</div>
      ...
      <div class="px-16px-48px-80px tw-gap-10">
        <div class="max-layout-width-overflow-auto">
          ...
          <div class="gap-16px-24px-24px tw-flex tw-justify-between tw-flex-col xl:tw-flex-row">
            ...
            >{{ $t('Primelight OU was established as an alliance of consulting companies in the Baltic States') }}</div>
          </div>
          <!-- bottom -->
