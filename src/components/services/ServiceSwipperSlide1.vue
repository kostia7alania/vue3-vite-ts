<template>
  <div class="tw-flex tw-justify-between tw-px-40 tw-pt-14">
    <!-- left -->
    <div class="tw-pt-20">
      <div class="tw-font-semibold tw-text-6xl">
        <div>The Challengeʳ</div>
        <div>Advisory</div>
      </div>
      <div class="tw-pt-5 tw-text-gray-2 tw-text-lg tw-font-medium">
